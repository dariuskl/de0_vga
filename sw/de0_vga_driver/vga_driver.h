...
/*! Unsigned int of 64 bit */
typedef	unsigned long long	uint64;
/*! Signed int of 64 bit */
typedef	signed long long	int64;
/*! Unsigned int of 32 bit */
typedef	unsigned int		uint32;
/*! Signed int of 32 bit */
typedef signed int			int32;
/*! Unsigned int of 16 bit */
typedef	unsigned short		uint16;
/*! Signed int of 16 bit */
typedef	signed short		int16;
/*! Unsigned int of 8 bit */
...
/*!
 *	\struct frame_buffer
 *	\brief	Serves as a handle to the frame buffer pixel data and for configuration purposes.
 */
typedef struct {
	/*! Pointer to the pixel data */
	uint64 *p_pxs;
	/*! Horizontal text offset, default is 20 */
	uint16 text_offset_x;
	/*! Vertical text offset, default is 120 to leave space for the FH-Koeln logo */
	uint16 text_offset_y;
} frame_buffer;
...
/*!
 * 	\def	g (x)
 * 	\brief	Returns the color value for a pixel of the grayscale intensity x.
 *
 * 	Where x can be any value from 0 to 15. Greater values are cutoff to the last 4 Bit.
 */
#define g(x)							((x << 8) | (x << 4) | x)

/*!
 * 	\def	rgb (r, g, b)
 * 	\brief	Returns the color value for a pixel of the color components r, g and b.
 *
 * 	Where each of r, g and b can be any value from 0 to 15. Greater values are cutoff to the last 4 Bit.
 */
